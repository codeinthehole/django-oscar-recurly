...
from recurly.gateway import (
    AUTH, COMPLETE, PURCHASE, REFUND, VALIDATE, Gateway
)
from recurly.models import OrderTransaction
...
class Facade(object):
    ...
    def __init__(self):
        self.gateway = Gateway(
            ...
            settings.RECURLY_API_KEY,
            settings.RECURLY_PRIVATE_KEY,
            getattr(settings, 'RECURLY_DEFAULT_CURRENCY', 'USD')
        )
